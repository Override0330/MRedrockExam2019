 ...
 * 3.切换到歌曲详情页
 */
class HomePageActivity : BaseActivity<HomePageContract.HomePageView, HomePagePresenter>(), HomePageContract.HomePageView, View.OnClickListener{
    ...
    override fun showMusic(name: String, author: String, imageUrl: String) {
        tv_homepage_music_name.text = name
